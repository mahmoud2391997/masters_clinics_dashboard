...
})(window,document,'script','dataLayer','GTM-MKB6XGFZ');</script>
...
<meta name="viewport" content="width=device-width,initial-scale=1"/><meta name="theme-color" content="#000000"/><meta name="description" content="Web site created using create-react-app"/><link rel="apple-touch-icon" href="/logo192.png"/><link rel="manifest" href="/manifest.json"/><title>Masters Clinics</title><script defer="defer" src="/static/js/main.022b6ddb.js"></script><link href="/static/css/main.2e1faebe.css" rel="stylesheet"></head><body>
    <!-- Google Tag Manager (noscript) -->
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-MKB6XGFZ"
