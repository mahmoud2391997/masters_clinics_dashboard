    ...
    return (_jsxs("div", { dir: "rtl", className: "flex h-screen w-full relative", children: [_jsx(Sidebar, { toggleSidebar: setIsSidebarOpen }), _jsx("div", { className: "flex-grow transition-all duration-300", style: {
                    ...
                    marginRight: location.pathname === "/"
                        ...
                        : isSidebarOpen
                            ? "240px"
                            : "64px",
                }, children: _jsxs(Routes, { children: [_jsx(Route, { path: "/", element: _jsx(Login, {}) }), isAuthenticated && (_jsxs(_Fragment, { children: [(role === "admin" || role === "mediabuyer") && (_jsx(Route, { path: "/landingPage", element: _jsx(LandingPageForm, {}) })), (role === "admin" || role === "mediabuyer") && (_jsx(Route, { path: "/landingPage/:id", element: _jsx(LandingPageEditor, {}) })), _jsx(Route, { path: "/doctors", element: _jsx(DataTableHeaders, {}) }), _jsx(Route, { path: "/doctors/:id", element: _jsx(DoctorSingle, {}) }), _jsx(Route, { path: "/departments", element: _jsx(DepartmentsStatsGrid, {}) }), _jsx(Route, { path: "/branches/:id", element: _jsx(BranchSingle, {}) }), _jsx(Route, { path: "/leads", element: _jsx(DataTable, { userRole: role }) }), _jsx(Route, { path: "/regions&branches", element: _jsx(RegionsBranchesPage, {}) }), _jsx(Route, { path: "/services", element: _jsx(ServicesManager, {}) }), _jsx(Route, { path: "/offers", element: _jsx(OffersPage, {}) }), _jsx(Route, { path: "/services/:id", element: _jsx(CategorySinglePage, {}) }), _jsx(Route, { path: "/devices", element: _jsx(MedicalDevicesPage, {}) })] }))] }) })] }));
}
export default App;
