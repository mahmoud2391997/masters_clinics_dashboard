...
import { faCalendarCheck,  faCity,   faGift,   faHouseMedical,   faLaptopMedical,   faPager,  faSignOutAlt, faStethoscope, faUserDoctor } from "@fortawesome/free-solid-svg-icons";
