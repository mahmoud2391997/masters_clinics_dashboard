...
import { Box, TextField, MenuItem, TableContainer, Paper, Table, TableHead, TableRow, TableCell, TableBody, Button, Dialog, DialogTitle, DialogContent, DialogActions, List, ListItem, ListItemText, Typography, IconButton, ListItemSecondaryAction, Chip, Tooltip, Alert, Popover, Badge, FormControl, InputLabel, Select, } from "@mui/material";
...
const DataTable = ({ formFields = defaultFormFields, data = defaultData, userRole = "customercare", }) => {
    ...
    return (_jsxs("div", { className: " overflow-auto pr-2", children: [error && (_jsx(Alert, { severity: "error", sx: { mb: 2 }, onClose: () => setState((prev) => ({ ...prev, error: null })), children: error })), _jsxs(Box, { sx: { mb: 2, display: "flex", gap: 2, flexWrap: "wrap" }, className: "pb-1 pt-2", children: [_jsx(TextField, { label: "\u0628\u062D\u062B", value: search, onChange: handleChange("search"), sx: { minWidth: 200 } }), _jsxs(FormControl, { sx: { minWidth: 120 }, size: "small", children: [_jsx(InputLabel, { children: "\u0627\u0644\u0641\u0631\u0639" }), _jsxs(Select, { value: branchFilter, label: "\u0627\u0644\u0641\u0631\u0639", onChange: handleSelectChange("branchFilter"), children: [_jsx(MenuItem, { value: "all", children: "\u0627\u0644\u0643\u0644" }), branchOptions.map((branch) => (_jsx(MenuItem, { value: branch, children: branch }, branch)))] })] }), _jsxs(FormControl, { sx: { minWidth: 120 }, size: "small", children: [_jsx(InputLabel, { children: "\u062D\u0627\u0644\u0629 \u0627\u0644\u062F\u0641\u0639" }), _jsxs(Select, { value: paymentFilter, label: "\u062D\u0627\u0644\u0629 \u0627\u0644\u062F\u0641\u0639", onChange: handleSelectChange("paymentFilter"), children: [_jsx(MenuItem, { value: "all", children: "\u0627\u0644\u0643\u0644" }), _jsx(MenuItem, { value: "paid", children: "\u0645\u062F\u0641\u0648\u0639" }), _jsx(MenuItem, { value: "pending", children: "\u0645\u0639\u0644\u0642" }), _jsx(MenuItem, { value: "unpaid", children: "\u063A\u064A\u0631 \u0645\u062F\u0641\u0648\u0639" })] })] }), _jsxs(FormControl, { sx: { minWidth: 120 }, size: "small", children: [_jsx(InputLabel, { children: "\u0627\u0644\u062A\u0648\u062B\u064A\u0642" }), _jsxs(Select, { value: authFilter, label: "\u0627\u0644\u062A\u0648\u062B\u064A\u0642", onChange: handleSelectChange("authFilter"), children: [_jsx(MenuItem, { value: "all", children: "\u0627\u0644\u0643\u0644" }), _jsx(MenuItem, { value: "authed", children: "\u0645\u0648\u062B\u0642" }), _jsx(MenuItem, { value: "notAuthed", children: "\u063A\u064A\u0631 \u0645\u0648\u062B\u0642" })] })] }), _jsxs(FormControl, { sx: { minWidth: 120 }, size: "small", children: [_jsx(InputLabel, { children: "\u0627\u0644\u062D\u0627\u0644\u0629" }), _jsxs(Select, { value: statusFilter, label: "\u0627\u0644\u062D\u0627\u0644\u0629", onChange: handleSelectChange("statusFilter"), children: [_jsx(MenuItem, { value: "all", children: "\u0627\u0644\u0643\u0644" }), appointmentStatusOptions.map((status) => (_jsx(MenuItem, { value: status, children: status }, status)))] })] })] }), _jsxs(TableContainer, { component: Paper, sx: {
                    maxHeight: { xs: 400, sm: 500 },
                    overflowX: "auto", // Ensure horizontal scrolling
                    width: "100%",
                    maxWidth: "100vw", // Prevent overflow outside viewport
                }, className: "!max-h-[75vh]", children: ["        ", _jsxs(Table, { stickyHeader: true, size: "small", "aria-label": "appointments table", children: [_jsx(TableHead, { children: _jsxs(TableRow, { children: [visibleFormFields.map((field) => (_jsx(TableCell, { align: "left", children: field.label }, field.key))), _jsx(TableCell, { children: "\u062D\u0627\u0644\u0629 \u0627\u0644\u062F\u0641\u0639" }), _jsx(TableCell, { children: "\u0627\u0644\u062A\u0648\u062B\u064A\u0642" }), _jsx(TableCell, { children: "\u0627\u0644\u062D\u0627\u0644\u0629" }), _jsx(TableCell, { children: "\u0645\u0648\u0639\u062F \u0627\u0644\u062D\u062C\u0632" }), _jsx(TableCell, { children: "\u0622\u062E\u0631 \u062D\u0627\u0644\u0629" }), _jsx(TableCell, { children: "\u0633\u062C\u0644\u0627\u062A \u0627\u0644\u0627\u062A\u0635\u0627\u0644" }), _jsx(TableCell, { children: "\u0625\u062C\u0631\u0627\u0621\u0627\u062A" })] }) }), _jsxs(TableBody, { className: "p-10", children: [loading && (_jsx(TableRow, { children: _jsx(TableCell, { colSpan: visibleFormFields.length + 7, align: "center", children: "... \u062C\u0627\u0631\u064A \u0627\u0644\u062A\u062D\u0645\u064A\u0644" }) })), !loading && filteredData.length === 0 && (_jsx(TableRow, { children: _jsx(TableCell, { colSpan: visibleFormFields.length + 7, align: "center", children: "\u0644\u0627 \u062A\u0648\u062C\u062F \u0628\u064A\u0627\u0646\u0627\u062A" }) })), filteredData.map((row) => {
                                        ...
                                        return (_jsxs(TableRow, { hover: true, children: [visibleFormFields.map((field) => (_jsx(TableCell, { children: field.key === "createdAt"
                                                        ...
                                                        : field.key === "doctor_offer"
                                                            ...
                                                            : (row[field.key] ?? "-") }, field.key))), _jsx(TableCell, { children: _jsx(Chip, { label: row.payment_status === "paid" ? "مدفوع" : row.payment_status === "pending" ? "معلق" : "غير مدفوع", color: paymentStatusColors[row.payment_status] || "default", size: "small" }) }), _jsx(TableCell, { children: _jsx(Badge, { color: authStatusColors[row.is_authed.toString()] || "default", badgeContent: row.is_authed ? "✓" : "✗" }) }), _jsx(TableCell, { children: userRole === "customercare" ? (_jsx(FormControl, { size: "small", fullWidth: true, children: _jsx(Select, { value: row.status, onChange: (e) => updateAppointmentStatus(row.id, e.target.value), children: appointmentStatusOptions.map((status) => (_jsx(MenuItem, { value: status, children: appointmentStatusLabels[status] }, status))) }) })) : (_jsx(Chip, { label: appointmentStatusLabels[row.status] || row.status, color: appointmentStatusColors[row.status] || "default", size: "small" })) }), _jsx(TableCell, { children: _jsxs(Box, { sx: { display: "flex", alignItems: "center", gap: 1 }, children: [_jsx("span", { children: renderScheduledAt(row.scheduledAt) }), canScheduleAppointments && (_jsx(IconButton, { size: "small", onClick: (e) => openSchedulePopup(e, row), color: row.scheduledAt ? "primary" : "default", children: _jsx(ScheduleIcon, { fontSize: "small" }) }))] }) }), _jsx(TableCell, { children: lastCall ? (_jsx(Tooltip, { title: `${new Date(lastCall.timestamp).toLocaleString("ar-EG", {
                                                            year: "numeric",
                                                            month: "2-digit",
                                                            day: "2-digit",
                                                            hour: "2-digit",
                                    ...
                                    })] })] })] }), canScheduleAppointments && (_jsx(Popover, { id: scheduleId, open: isScheduleOpen, anchorEl: scheduleAnchorEl, onClose: closeSchedulePopup, anchorOrigin: {
                    vertical: "bottom",
                    horizontal: "left",
                }, transformOrigin: {
                    vertical: "top",
                    horizontal: "left",
                                    ...
                                    textField: {
                                        ...
                                        dir: "rtl",
                                                                    ...
                                                                    minute: "2-digit",
                                                                    hour12: true,
                                                                }), " ", "- \u0627\u0644\u0648\u0643\u064A\u0644: ", log.agentName || "غير معروف"] })] }) }), canScheduleAppointments && (_jsxs(ListItemSecondaryAction, { children: [_jsx(Tooltip, { title: "\u062A\u0639\u062F\u064A\u0644", children: _jsx(IconButton, { edge: "end", "aria-label": "edit", onClick: () => startEditingLog(log), size: "small", children: _jsx(EditIcon, { fontSize: "small" }) }) }), _jsx(Tooltip, { title: "\u062D\u0630\u0641", children: _jsx(IconButton, { edge: "end", "aria-label": "delete", onClick: () => log.id && deleteCallLog(log.id), size: "small", children: _jsx(DeleteIcon, { fontSize: "small" }) }) })] }))] })) }, log.id))) }), canScheduleAppointments && (_jsxs(Box, { sx: { mt: 2, borderTop: "1px solid #eee", pt: 2 }, children: [_jsx(Typography, { variant: "subtitle1", gutterBottom: true, children: "\u0625\u0636\u0627\u0641\u0629 \u0633\u062C\u0644 \u062C\u062F\u064A\u062F" }), _jsx(TextField, { select: true, label: "\u0627\u0644\u062D\u0627\u0644\u0629", value: newCallLogStatus, onChange: handleChange("newCallLogStatus"), fullWidth: true, margin: "dense", size: "small", required: true, children: statusOptions.map((status) => (_jsx(MenuItem, { value: status, children: _jsxs(Box, { display: "flex", alignItems: "center", gap: 1, children: [_jsx(Chip, { label: status, color: statusColors[status] || "default", size: "small", sx: { mr: 1 } }), status] }) }, status))) }), _jsx(TextField, { label: "\u0645\u0644\u0627\u062D\u0638\u0627\u062A", value: newCallLogNotes, onChange: handleChange("newCallLogNotes"), fullWidth: true, multiline: true, rows: 2, margin: "dense", size: "small" }), _jsx(Button, { variant: "contained", startIcon: _jsx(AddIcon, {}), sx: { mt: 1 }, onClick: handleAddCallLogClick, disabled: !newCallLogStatus, size: "small", children: "\u0625\u0636\u0627\u0641\u0629 \u0633\u062C\u0644" })] }))] }), _jsx(DialogActions, { children: _jsx(Button, { onClick: closeCallLogDialog, size: "small", children: "\u0625\u063A\u0644\u0627\u0642" }) })] }), _jsxs(Dialog, { open: deleteConfirmOpen, onClose: closeDeleteConfirm, children: [_jsx(DialogTitle, { children: "\u062A\u0623\u0643\u064A\u062F \u0627\u0644\u062D\u0630\u0641" }), _jsx(DialogContent, { children: _jsx(Alert, { severity: "warning", children: "\u0647\u0644 \u0623\u0646\u062A \u0645\u062A\u0623\u0643\u062F \u0623\u0646\u0643 \u062A\u0631\u064A\u062F \u062D\u0630\u0641 \u0647\u0630\u0627 \u0627\u0644\u0645\u0648\u0639\u062F\u061F \u0647\u0630\u0627 \u0627\u0644\u0625\u062C\u0631\u0627\u0621 \u0644\u0627 \u064A\u0645\u0643\u0646 \u0627\u0644\u062A\u0631\u0627\u062C\u0639 \u0639\u0646\u0647." }) }), _jsxs(DialogActions, { children: [_jsx(Button, { onClick: closeDeleteConfirm, color: "primary", children: "\u0625\u0644\u063A\u0627\u0621" }), _jsx(Button, { onClick: confirmDeleteAppointment, color: "error", variant: "contained", children: "\u062D\u0630\u0641" })] })] })] }));
};
