...
const DataTable = ({ formFields = defaultFormFields, data = defaultData, userRole = "customercare", }) => {
    ...
    const renderDoctorOffer = (row) => (_jsxs("div", { className: "flex flex-col gap-1", children: [row.doctor && _jsxs("div", { className: "text-sm", children: ["\u0627\u0644\u0637\u0628\u064A\u0628: ", row.doctor] }), row.offer && _jsxs("div", { className: "text-sm", children: ["\u0627\u0644\u0639\u0631\u0636: ", row.offer] }), !row.doctor && !row.offer && "-"] }));
