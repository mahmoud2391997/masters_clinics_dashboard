...
const BlogsPage = () => {
    ...
    const handleToggleActive = async (id, currentStatus) => {
        ...
        try {
            ...
            setBlogs(prevBlogs => prevBlogs.map(blog => blog.id === id ? { ...blog, is_active: newStatus } : blog));
            // Then make API call
            ...
            setBlogs(prevBlogs => prevBlogs.map(blog => blog.id === id ? { ...blog, is_active: currentStatus } : blog));
        }
    };
    const handlePriorityChange = async (id, newPriority) => {
        try {
            // Optimistically update UI first
            setBlogs(prevBlogs => prevBlogs.map(blog => blog.id === id ? { ...blog, priority: newPriority } : blog));
            // Then make API call
            await axios.put(`https://www.ss.mastersclinics.com/blogs/${id}`, {
    ...
    return (_jsx("div", { className: "p-4 md:p-8 bg-gray-50 min-h-screen", children: _jsxs("div", { className: "max-w-7xl mx-auto", children: [_jsx("h1", { className: "text-3xl font-bold text-gray-800 mb-8 text-center", children: "\u0625\u062F\u0627\u0631\u0629 \u0627\u0644\u0645\u062F\u0648\u0646\u0627\u062A" }), _jsx("div", { className: "mb-8", children: _jsxs("div", { className: "relative max-w-md mx-auto", children: [_jsx("input", { type: "text", placeholder: "\u0628\u062D\u062B \u0628\u0639\u0646\u0648\u0627\u0646 \u0627\u0644\u0645\u062F\u0648\u0646\u0629...", value: search, onChange: (e) => setSearch(e.target.value), className: "w-full p-3 pl-10 border rounded-lg shadow-sm focus:ring-2 focus:ring-primary focus:border-transparent" }), _jsx("svg", { className: "absolute left-3 top-3.5 h-5 w-5 text-gray-400", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24", children: _jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "2", d: "M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" }) })] }) }), _jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-3 gap-8", children: [_jsx("div", { className: "lg:col-span-1", children: _jsxs("div", { className: "bg-white rounded-xl shadow-md p-6 sticky top-6", children: [_jsx("h2", { className: "text-xl font-bold text-gray-800 mb-4", children: "\u0625\u0636\u0627\u0641\u0629 \u0645\u062F\u0648\u0646\u0629 \u062C\u062F\u064A\u062F\u0629" }), _jsxs("form", { onSubmit: handleAddBlog, className: "space-y-4", children: [_jsxs("div", { children: [_jsx("label", { className: "block text-sm font-medium text-gray-700 mb-1", children: "\u0627\u0644\u0627\u0633\u0645 \u0627\u0644\u0645\u062E\u062A\u0635\u0631 *" }), _jsx("input", { type: "text", value: form.slug, onChange: (e) => setForm({ ...form, slug: e.target.value }), className: `w-full p-2 border rounded-lg ${formErrors.slug ? "border-red-500" : "border-gray-300"}` }), formErrors.slug && _jsx("p", { className: "text-red-500 text-xs mt-1", children: formErrors.slug })] }), _jsxs("div", { children: [_jsx("label", { className: "block text-sm font-medium text-gray-700 mb-1", children: "\u0627\u0644\u0639\u0646\u0648\u0627\u0646 *" }), _jsx("input", { type: "text", value: form.title2, onChange: (e) => setForm({ ...form, title2: e.target.value }), className: `w-full p-2 border rounded-lg ${formErrors.title2 ? "border-red-500" : "border-gray-300"}` }), formErrors.title2 && _jsx("p", { className: "text-red-500 text-xs mt-1", children: formErrors.title2 })] }), _jsxs("div", { children: [_jsx("label", { className: "block text-sm font-medium text-gray-700 mb-1", children: "\u0627\u0633\u0645 \u0627\u0644\u0643\u0627\u062A\u0628 *" }), _jsx("input", { type: "text", value: form.author, onChange: (e) => setForm({ ...form, author: e.target.value }), className: `w-full p-2 border rounded-lg ${formErrors.author ? "border-red-500" : "border-gray-300"}` }), formErrors.author && _jsx("p", { className: "text-red-500 text-xs mt-1", children: formErrors.author })] }), _jsxs("div", { children: [_jsx("label", { className: "block text-sm font-medium text-gray-700 mb-1", children: "\u0627\u0644\u0645\u062D\u062A\u0648\u0649 *" }), _jsx("textarea", { value: form.content, onChange: (e) => setForm({ ...form, content: e.target.value }), rows: 4, className: `w-full p-2 border rounded-lg ${formErrors.content ? "border-red-500" : "border-gray-300"}` }), formErrors.content && _jsx("p", { className: "text-red-500 text-xs mt-1", children: formErrors.content })] }), _jsxs("div", { children: [_jsx("label", { className: "block text-sm font-medium text-gray-700 mb-1", children: "\u0627\u0644\u0623\u0648\u0644\u0648\u064A\u0629" }), _jsx("input", { type: "number", value: form.priority, onChange: (e) => setForm({ ...form, priority: parseInt(e.target.value) || 0 }), className: "w-full p-2 border border-gray-300 rounded-lg", min: "0" }), _jsx("p", { className: "text-xs text-gray-500 mt-1", children: "\u0643\u0644\u0645\u0627 \u0632\u0627\u062F \u0627\u0644\u0631\u0642\u0645 \u0632\u0627\u062F\u062A \u0627\u0644\u0623\u0648\u0644\u0648\u064A\u0629" })] }), _jsxs("div", { children: [_jsx("label", { className: "block text-sm font-medium text-gray-700 mb-1", children: "\u0645\u0644\u0641 \u0627\u0644\u0635\u0648\u0631\u0629" }), _jsx("input", { type: "file", onChange: (e) => setForm({ ...form, imageFile: e.target.files?.[0] }), className: "w-full p-2 border border-gray-300 rounded-lg" })] }), _jsxs("div", { className: "flex items-center", children: [_jsx("input", { type: "checkbox", id: "is_active", checked: form.is_active === 1, onChange: (e) => setForm({ ...form, is_active: +e.target.checked }), className: "h-4 w-4 text-primary focus:ring-primary border-gray-300 rounded" }), _jsx("label", { htmlFor: "is_active", className: "ml-2 block text-sm text-gray-700", children: "\u062A\u0641\u0639\u064A\u0644 \u0627\u0644\u0645\u062F\u0648\u0646\u0629" })] }), _jsx("button", { type: "submit", className: "w-full bg-green-600 hover:bg-green-700 text-white font-medium py-2 px-4 rounded-lg transition duration-200", children: "\u0625\u0636\u0627\u0641\u0629" })] })] }) }), _jsx("div", { className: "lg:col-span-2", children: filteredBlogs.length === 0 ? (_jsx("div", { className: "bg-white rounded-xl shadow-md p-8 text-center", children: "\u0644\u0645 \u064A\u062A\u0645 \u0627\u0644\u0639\u062B\u0648\u0631 \u0639\u0644\u0649 \u0645\u062F\u0648\u0646\u0627\u062A" })) : (_jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-6", children: filteredBlogs.map((blog) => (_jsxs("div", { className: `bg-white rounded-xl shadow-md overflow-hidden hover:shadow-lg transition duration-200 relative ${!blog.is_active ? 'opacity-70' : ''}`, children: [_jsxs("div", { className: "absolute top-2 right-2 flex space-x-2", children: [_jsx("button", { onClick: () => handleToggleActive(blog.id, blog.is_active), className: `p-2 rounded-full ${blog.is_active ? 'bg-yellow-500 hover:bg-yellow-600' : 'bg-green-500 hover:bg-green-600'} text-white transition`, title: blog.is_active ? "تعطيل المدونة" : "تفعيل المدونة", children: blog.is_active ? (_jsx("svg", { xmlns: "http://www.w3.org/2000/svg", className: "h-4 w-4", fill: "none", viewBox: "0 0 24 24", stroke: "currentColor", children: _jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, d: "M20 12H4" }) })) : (_jsx("svg", { xmlns: "http://www.w3.org/2000/svg", className: "h-4 w-4", fill: "none", viewBox: "0 0 24 24", stroke: "currentColor", children: _jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, d: "M5 13l4 4L19 7" }) })) }), _jsx("button", { onClick: () => handleDeleteBlog(blog.id), className: "bg-red-500 text-white p-2 rounded-full hover:bg-red-600 transition", title: "\u062D\u0630\u0641 \u0627\u0644\u0645\u062F\u0648\u0646\u0629", children: _jsx("svg", { xmlns: "http://www.w3.org/2000/svg", className: "h-4 w-4", fill: "none", viewBox: "0 0 24 24", stroke: "currentColor", children: _jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, d: "M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16" }) }) })] }), !blog.is_active && (_jsx("div", { className: "absolute top-2 left-2 bg-gray-500 text-white text-xs px-2 py-1 rounded", children: "\u0645\u0639\u0637\u0644\u0629" })), _jsxs("div", { className: "absolute top-2 right-22 bg-blue-500 text-white text-xs px-2 py-1 rounded", children: ["\u0627\u0644\u0623\u0648\u0644\u0648\u064A\u0629: ", blog.priority || 0] }), _jsx("div", { className: "h-48 overflow-hidden", children: _jsx("img", { src: getImageUrl(blog.image || "") || "/placeholder.png", alt: blog.title2, className: "w-full h-full object-cover" }) }), _jsxs("div", { className: "p-6", children: [_jsx("h3", { className: "text-xl font-bold text-gray-800 mb-2", children: blog.title2 }), _jsxs("p", { className: "text-sm text-gray-600 mb-4", children: ["\u0628\u0648\u0627\u0633\u0637\u0629 ", blog.author] }), _jsx("p", { className: "text-gray-700 mb-4 line-clamp-2", children: blog.content }), _jsxs("div", { className: "flex items-center mb-4", children: [_jsx("label", { className: "block text-sm font-medium text-gray-700 mr-2", children: "\u062A\u063A\u064A\u064A\u0631 \u0627\u0644\u0623\u0648\u0644\u0648\u064A\u0629:" }), _jsx("input", { type: "number", value: blog.priority || 0, onChange: (e) => handlePriorityChange(blog.id, parseInt(e.target.value) || 0), className: "w-20 p-1 border border-gray-300 rounded", min: "0" })] }), _jsxs("div", { className: "flex justify-between items-center", children: [_jsxs(Link, { to: `/blogs/${blog.id}`, className: "inline-flex items-center text-green-600 hover:text-green-700 font-medium", children: ["\u0627\u0642\u0631\u0623 \u0627\u0644\u0645\u0632\u064A\u062F", _jsx("svg", { className: "ml-1 w-4 h-4", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24", children: _jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "2", d: "M9 5l7 7-7 7" }) })] }), _jsx("span", { className: "text-xs text-gray-500", children: new Date(blog.created_at).toLocaleDateString('ar-EG') })] })] })] }, blog.id))) })) })] })] }) }));
};
