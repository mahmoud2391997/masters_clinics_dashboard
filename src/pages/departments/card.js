...
const CardStats = ({ department, branches, onUpdateSuccess, onDeleteSuccess }) => {
    ...
    const [priority, setPriority] = useState(department.priority || 0);
