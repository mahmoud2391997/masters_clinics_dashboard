...
const LandingPageEditor = () => {
    ...
    return (_jsxs(Box, { sx: { maxWidth: 1200, mx: 'auto', p: 3 }, dir: "rtl", children: [_jsx(Paper, { elevation: 2, sx: { p: 3, mb: 3 }, children: _jsxs(Box, { display: "flex", justifyContent: "space-between", alignItems: "center", children: [_jsxs(Box, { display: "flex", alignItems: "center", children: [_jsx(IconButton, { onClick: () => navigate(-1), sx: { mr: 2 }, children: _jsx(ArrowBack, {}) }), _jsx(Typography, { variant: "h4", children: isEditing ? 'تعديل صفحة الهبوط' : 'عرض صفحة الهبوط' })] }), _jsx(Box, { display: "flex", gap: 2, children: !isEditing ? (_jsxs(_Fragment, { children: [_jsx(Button, { variant: "contained", startIcon: _jsx(Edit, {}), onClick: () => setIsEditing(true), children: "\u062A\u0639\u062F\u064A\u0644" }), _jsx(FormControlLabel, { control: _jsx(Switch, { checked: currentLandingPage.activated, onChange: toggleStatus }), label: currentLandingPage.activated ? 'مفعلة' : 'معطلة' }), _jsx(Button, { variant: "outlined", color: "error", startIcon: _jsx(Delete, {}), onClick: handleDelete, children: "\u062D\u0630\u0641" })] })) : (_jsxs(_Fragment, { children: [_jsx(Button, { variant: "contained", color: "success", startIcon: _jsx(Save, {}), onClick: handleSave, children: "\u062D\u0641\u0638" }), _jsx(Button, { variant: "outlined", startIcon: _jsx(Cancel, {}), onClick: handleCancel, children: "\u0625\u0644\u063A\u0627\u0621" })] })) })] }) }), _jsx(Card, { sx: { mb: 3 }, children: _jsxs(CardContent, { children: [_jsx(Typography, { variant: "h6", gutterBottom: true, children: "\u0627\u0644\u0645\u0639\u0644\u0648\u0645\u0627\u062A \u0627\u0644\u0623\u0633\u0627\u0633\u064A\u0629" }), isEditing ? (_jsxs(Box, { children: [_jsx(Box, { sx: { mb: 2 }, children: _jsx(TextField, { fullWidth: true, label: "\u0639\u0646\u0648\u0627\u0646 \u0627\u0644\u0635\u0641\u062D\u0629", value: currentLandingPage.title, onChange: (e) => dispatch(updateCurrentLandingPageSettings({ title: e.target.value })) }) }), _jsxs(Box, { sx: { mb: 2 }, children: [_jsx(Typography, { variant: "subtitle2", gutterBottom: true, children: "\u0627\u0644\u0645\u0646\u0635\u0627\u062A" }), _jsx(Box, { display: "flex", flexWrap: "wrap", gap: 1, children: Object.entries(currentLandingPage.platforms || {}).map(([platform, enabled]) => (_jsx(FormControlLabel, { control: _jsx(Switch, { checked: Boolean(enabled), onChange: (e) => dispatch(updateCurrentLandingPageSettings({
                                                        platforms: {
                                                            ...currentLandingPage.platforms,
                                                            [platform]: e.target.checked,
                                                        },
                                                    })) }), label: platform }, platform))) })] }), _jsxs(Box, { children: [_jsx(Typography, { variant: "subtitle2", gutterBottom: true, children: "\u0625\u0638\u0647\u0627\u0631 \u0627\u0644\u0623\u0642\u0633\u0627\u0645" }), _jsx(Box, { display: "flex", flexWrap: "wrap", gap: 1, children: Object.entries(currentLandingPage.showSections || {}).map(([section, enabled]) => (_jsx(FormControlLabel, { control: _jsx(Switch, { checked: Boolean(enabled), onChange: (e) => dispatch(updateCurrentLandingPageSettings({
                                                        showSections: {
                                                            ...currentLandingPage.showSections,
                                                            [section]: e.target.checked,
                                                        },
                                                    })) }), label: section }, section))) })] })] })) : (_jsxs(Box, { children: [_jsx(Box, { sx: { mb: 2 }, children: _jsxs(Typography, { children: [_jsx("strong", { children: "\u0627\u0644\u0639\u0646\u0648\u0627\u0646:" }), " ", currentLandingPage.title] }) }), _jsx(Box, { sx: { mb: 2 }, children: _jsxs(Typography, { children: [_jsx("strong", { children: "\u0627\u0644\u062D\u0627\u0644\u0629:" }), " ", currentLandingPage.activated ? 'مفعلة' : 'معطلة'] }) }), _jsxs(Box, { children: [_jsx(Typography, { children: _jsx("strong", { children: "\u0627\u0644\u0645\u0646\u0635\u0627\u062A:" }) }), _jsx(Box, { display: "flex", flexWrap: "wrap", gap: 1, mt: 1, children: Object.entries(currentLandingPage.platforms || {})
